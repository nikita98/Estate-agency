        ...
        <v-card class="elevation-12">
          ...
          <v-card-text>
            <v-form ref="form" v-model="valid" lazy-validation @submit.prevent="onSubmit">
              <v-text-field v-model="firstname" :rules="nameRules" label="Имя" required></v-text-field>
              <v-text-field v-model="lastname" :rules="nameRules" label="Фамилия" required></v-text-field>
